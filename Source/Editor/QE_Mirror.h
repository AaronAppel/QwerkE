...
// MIRROR_TYPE_ID(2017, Unused) // Previously QwerkE::Editor::EditorWindowSceneControls
...
MIRROR_TYPE_ID(2049, QwerkE::Editor::eSettingsOptions)
MIRROR_TYPE_ID(2050, QwerkE::Editor::EditorWindowPhysics)
