...
// Enums
MIRROR_INFO_FOR_TYPE(QwerkE::Editor::EditorWindowFlags)
MIRROR_CLASS_START(QwerkE::Editor::EditorWindowTypes)
MIRROR_CLASS_END

// Pointers
MIRROR_INFO_FOR_TYPE(std::pair<QwerkE::GUID, QwerkE::Editor::EditorWindow*>)
MIRROR_INFO_FOR_TYPE(std::pair<const QwerkE::GUID, QwerkE::Editor::EditorWindow*>)
MIRROR_INFO_FOR_TYPE(std::unordered_map<QwerkE::GUID, QwerkE::Editor::EditorWindow*>)
...
MIRROR_CLASS_START(QwerkE::UserSettings)
MIRROR_CLASS_END

MIRROR_CLASS_START(QwerkE::Project)
...
MIRROR_CLASS_END
MIRROR_INFO_FOR_TYPE(QwerkE::Editor::EditorWindow*)

MIRROR_CLASS_START(QwerkE::ProjectsData)
