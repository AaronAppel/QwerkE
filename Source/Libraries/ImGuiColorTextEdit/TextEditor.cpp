...
// BEGIN DIVERGENCE | aappel Jun 23rd, 2026 | Note
		// Add makeCursorVisible(); to key actions to better visualize cursor movement like home/end, arrow keys, page up/down, etc
// END DIVERGENCE
