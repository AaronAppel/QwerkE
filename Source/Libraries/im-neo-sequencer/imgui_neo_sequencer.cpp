...
namespace ImGui
{
    ...
    static void processCurrentFrame(FrameIndexType* frame, ImGuiNeoSequencerInternalData& context)
    {
        ...
        const auto hovered = ItemHoverable(pointerRect, GetCurrentWindow()->GetID("##_top_selector_neo"), ImGuiItemFlags_::ImGuiItemFlags_None);
    ...
    static bool createKeyframe(int32_t* frame)
    {
        ...
        bool hovered = ItemHoverable(bb, id, ImGuiActivateFlags_::ImGuiActivateFlags_None);
...
//
        ...
        *end = endFrameVal;
        ...
        const bool hovered = ItemHoverable(bb, GetCurrentWindow()->GetID("##zoom_slider"), ImGuiActivateFlags_::ImGuiActivateFlags_None);
