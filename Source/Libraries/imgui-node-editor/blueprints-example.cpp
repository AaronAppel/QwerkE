...
void Example::TouchNode(ed::NodeId id)
{
    m_NodeTouchTime[id] = m_TouchTime;
}

float Example::GetTouchProgress(ed::NodeId id)
{
...
Pin* Example::FindPin(ed::PinId id)
{
    if (!id)
        return nullptr;
...
Node* Example::SpawnSetTimerNode()
{
...
Node* Example::SpawnTraceByChannelNode()
{
...
Node* Example::SpawnTreeSequenceNode()
{
...
Node* Example::SpawnTreeTaskNode()
{
...
Node* Example::SpawnTreeTask2Node()
{
...
Node* Example::SpawnHoudiniTransformNode()
{
...
Node* Example::SpawnHoudiniGroupNode()
{
...
void Example::ShowStyleEditor(bool* show = nullptr)
{
