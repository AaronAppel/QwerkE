...
// #TODO Support gamepads with any number of buttons, like the RazerOrbweaver.
// Whether than means ignoring it as a gamepad, or expanding the button state query logic to more than 14 buttons.
...
u8 GamepadsCount();
const char* const GamepadName(const QGamepad a_GamepadId = QGamepad::e_GamepadId0);
