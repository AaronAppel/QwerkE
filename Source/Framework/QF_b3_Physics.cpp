...
namespace QwerkE {
    ...
    namespace Physics { // #TODO: Abstract from Bullet3 library
        ...
        {
            ASSERT(!g_CollisionConfiguration, "Physics already initialized!");
            ...
            btRigidBody* body = CreateRigidPlane(btVector3(0, 0, 0), 100.0f, 100.0f, 0.0f);
        ...
        void RegisterObject(btRigidBody* rigidBody)
        {
            ...
            g_CollisionShapes.push_back(rigidBody->getCollisionShape()); // TODO: Error handling
        ...
        void UnregisterObject(btRigidBody* rigidBody)
        {
            ...
            g_CollisionShapes.remove(rigidBody->getCollisionShape()); // TODO: Error handling
