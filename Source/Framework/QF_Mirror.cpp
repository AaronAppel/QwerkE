...
namespace QwerkE
{
	...
	MIRROR_CLASS_START(MenuBarData)
	MIRROR_CLASS_MEMBER(showFps)
	MIRROR_CLASS_END

	MIRROR_CLASS_START(UiData)
	MIRROR_CLASS_MEMBER(menuBarData)
	MIRROR_CLASS_END

	MIRROR_CLASS_START(ConfiguredGameKeys)
	MIRROR_CLASS_MEMBER(action1)
	MIRROR_CLASS_MEMBER(resetScene)
	MIRROR_CLASS_END
	...
	MIRROR_CLASS_MEMBER(frameworkData)
	MIRROR_CLASS_MEMBER(uiData)
	MIRROR_CLASS_MEMBER(scenes)
