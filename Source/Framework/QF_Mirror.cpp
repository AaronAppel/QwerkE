...
#ifdef _QDEARIMGUI
// From ImGuiStyle in imgui.h(300)
MIR_CLASS(ImVec2)
	MIR_CLASS_MEMBER(x)
	MIR_CLASS_MEMBER(y)
MIR_CLASS_END

// From ImGuiStyle in imgui.h(313)
MIR_CLASS(ImVec4)
	MIR_CLASS_MEMBER(x)
	MIR_CLASS_MEMBER(y)
	MIR_CLASS_MEMBER(z)
...
// From ImGuiCol_ in imgui.h(1823)
MIR_TYPE(ImVec4[ImGuiCol_COUNT])

// From ImGuiCol_ in imgui.h(1601)
MIR_TYPE(ImGuiDir)

// From ImGuiStyle in imgui.h(2371)
MIR_CLASS(ImGuiStyle)
	MIR_CLASS_MEMBER(FontSizeBase)
	MIR_CLASS_MEMBER(FontScaleMain)
	MIR_CLASS_MEMBER(FontScaleDpi)
	...
	MIR_CLASS_MEMBER(WindowBorderHoverPadding)
	...
	MIR_CLASS_MEMBER(ScrollbarPadding)
	MIR_CLASS_MEMBER(GrabMinSize)
	MIR_CLASS_MEMBER(GrabRounding)
	MIR_CLASS_MEMBER(LogSliderDeadzone)
	MIR_CLASS_MEMBER(ImageRounding)
	MIR_CLASS_MEMBER(ImageBorderSize)
	MIR_CLASS_MEMBER(TabRounding)
	MIR_CLASS_MEMBER(TabBorderSize)
	MIR_CLASS_MEMBER(TabMinWidthBase)
	MIR_CLASS_MEMBER(TabMinWidthShrink)
	MIR_CLASS_MEMBER(TabCloseButtonMinWidthSelected)
	MIR_CLASS_MEMBER(TabCloseButtonMinWidthUnselected)
	MIR_CLASS_MEMBER(TabBarBorderSize)
	MIR_CLASS_MEMBER(TabBarOverlineSize)
	MIR_CLASS_MEMBER(TableAngledHeadersAngle)
	MIR_CLASS_MEMBER(TableAngledHeadersTextAlign)
	MIR_CLASS_MEMBER(TreeLinesFlags)
	MIR_CLASS_MEMBER(TreeLinesSize)
	MIR_CLASS_MEMBER(TreeLinesRounding)
	MIR_CLASS_MEMBER(DragDropTargetRounding)
	MIR_CLASS_MEMBER(DragDropTargetBorderSize)
	MIR_CLASS_MEMBER(DragDropTargetPadding)
	MIR_CLASS_MEMBER(ColorMarkerSize)
	// MIR_CLASS_MEMBER(ColorButtonPosition)
	MIR_CLASS_MEMBER(ButtonTextAlign)
	MIR_CLASS_MEMBER(SelectableTextAlign)
	MIR_CLASS_MEMBER(InputTextCursorSize)
	MIR_CLASS_MEMBER(SeparatorSize)
	...
	MIR_CLASS_MEMBER(DockingNodeHasCloseButton)
