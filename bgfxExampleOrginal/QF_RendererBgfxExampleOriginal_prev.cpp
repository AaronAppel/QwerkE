...
bool local_init(int32_t _argc, const char* const* _argv, uint32_t _width, uint32_t _height)
{
...
int Run(int _argc, char** _argv, uint32_t _width, uint32_t _height)
{
	if (!local_init(_argc, _argv, _width, _height))
	{
		return 1;
	}
