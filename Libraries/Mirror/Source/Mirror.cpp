...
MIRROR_PRIMITIVE_TYPE(m_int8_t)
MIRROR_PRIMITIVE_TYPE(m_int16_t)
MIRROR_PRIMITIVE_TYPE(m_int32_t)
MIRROR_PRIMITIVE_TYPE(m_int64_t)
MIRROR_PRIMITIVE_TYPE(m_uint8_t)
MIRROR_PRIMITIVE_TYPE(m_uint16_t)
MIRROR_PRIMITIVE_TYPE(m_uint32_t)
MIRROR_PRIMITIVE_TYPE(m_uint64_t)

typedef bool m_bool;
typedef char m_char;

MIRROR_PRIMITIVE_TYPE(m_bool)
MIRROR_PRIMITIVE_TYPE(m_char)

typedef float m_float;
typedef double m_double;

MIRROR_PRIMITIVE_TYPE(m_float)
MIRROR_PRIMITIVE_TYPE(m_double)

typedef char* m_charPtr;
typedef const char* m_constCharPtr;

MIRROR_PRIMITIVE_TYPE(m_charPtr)
MIRROR_PRIMITIVE_TYPE(m_constCharPtr)
