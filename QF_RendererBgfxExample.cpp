...
void local_init(int32_t _argc, const char* const* _argv, uint32_t _width, uint32_t _height)
{
...
int QwerkE::Renderer::RunBgfxExample(int32_t _argc, const char* const* _argv, uint32_t _width, uint32_t _height)
{
	local_init(_argc, _argv, _width, _height);
